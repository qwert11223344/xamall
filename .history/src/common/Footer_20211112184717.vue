<template>
    ...
    <div class="container">
      <div class="siteinfo">
        ...
        <ul class="c4">
          <li class="tel"><a class="c5" href="http://wpa.qq.com/msgrd?v=3&uin=2206808590&site=qq&menu=yes" target="_blank">2206808590</a></li>
          <li class="time">周一至周日 10:00-23:00</li>
          <li class="online">
            <w-button text="在线帮助" class="button" @btnClick="open3"></w-button>
          </li>
        </ul>
      </div>

      <div class="copyright">
        <h4 class="content-c2">Copyright ©2021, wyn Co., Ltd. All Rights Reserved.本网站设计内容大部分属锤子科技</h4>
        <ul class="privacy">
          <li class="content-c1"><a class="content-c0" @click="open1">法律声明</a></li>
          <li class="content-c1"><a class="content-c0" @click="open2">隐私条款</a></li>
          <li class="content-c1"><a class="content-c0" target="_blank" href="https://github.com/qwert11223344">开发者中心</a></li>
        </ul>
      </div>
      <div class="cop">
        <a class="content-c3" href="" target="_blank">
          <span class="content-c3">蜀ICP备***********</span>
          <span class="content-c3">蜀ICP证***********</span>
        </a>
      </div>
    </div>
  </div>
