			...
			<transition name="fade">
				<div class="shop-content" v-show="showCart">
					...
					<ul>
						...
						>
							<div class="product_item">
								...
								<div class="delete">
									<span @click.stop="_delProd({ Id: item.id })">
					...
					<div class="cart_footer">
						...
						<el-button type="primary" round plain @click="toshopCart"
							>去购物车
						</el-button>
					</div>
				</div>
...
import { RESET_PROD, ADD_CART } from "store/mutation-types.js";
