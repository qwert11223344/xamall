...
export default {
	...
	created() {
		...
		getDetail(this.productId).then((res) => {
			console.log(res);
			this.product = res;
			this.productMsg = res.prod_del_img || "";
			this.small.push(
				Object.assign({}, { prod_small_img1: res.prod_small_img1 })
			);
			this.small.push(
				Object.assign({}, { prod_small_img2: res.prod_small_img2 })
			);
			this.small.push(
				Object.assign({}, { prod_small_img3: res.prod_small_img3 })
			);
			this.small.push(
				Object.assign({}, { prod_small_img4: res.prod_small_img4 })
			);
			this.small.push(
				Object.assign({}, { prod_small_img5: res.prod_small_img5 })
			);
			this.big = this.small[0];
		});
	},
