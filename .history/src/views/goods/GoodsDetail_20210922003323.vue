					...
					<div class="thumbnail">
						<ul>
							<li
								...
								@click="big = item"
							>
								<img v-lazy="item.product_img1" :alt="product.productName" />
							</li>
						</ul>
					</div>
					<div class="thumb">
...
export default {
	...
	created() {
		...
		getDetail(this.productId).then((res) => {
			...
			this.small.push(
				Object.assign({}, { prod_small_img1: data.prod_small_img1 })
			);
			this.small.push(
				Object.assign({}, { prod_small_img2: data.prod_small_img2 })
			);
			this.small.push(
				Object.assign({}, { prod_small_img3: data.prod_small_img3 })
			);
			this.small.push(
				Object.assign({}, { prod_small_img4: data.prod_small_img4 })
			);
			this.small.push(
				Object.assign({}, { prod_small_img5: data.prod_small_img5 })
			);
			this.big = this.small[0];
		});
	},
