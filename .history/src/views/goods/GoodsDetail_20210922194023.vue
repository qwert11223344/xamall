...
export default {
	...
	created() {
		...
		getDetail(this.productId).then((res) => {
			...
			if (Object.keys(data.prod_small_img1) != "")
				this.small.push(data.prod_small_img1);
			if (Object.keys(data.prod_small_img2) != "")
				this.small.push(data.prod_small_img2);
			if (Object.keys(data.prod_small_img3) != "")
				this.small.push(data.prod_small_img3);
			if (Object.keys(data.prod_small_img4) != "")
				this.small.push(data.prod_small_img4);
			if (Object.keys(data.prod_small_img5) != "")
