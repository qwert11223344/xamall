		...
		<div class="gray-box">
			<div class="gallery-wrapper">
				<div class="gallery">
					...
					<div class="thumb">
						<div class="big">
							<img :src="big" :alt="product.product_title" />
						</div>
					</div>
				</div>
			</div>
...
export default {
	...
	created() {
		...
		getDetail(this.productId).then((res) => {
			...
			let data = res.data;
			this.product = data;
			console.log(Object.keys(data.prod_small_img1));
			this.productMsg = data.prod_del_img || "";
			if (Object.keys(data.prod_small_img1) != null)
				this.small.push(data.prod_small_img1);
			if (Object.keys(data.prod_small_img2) != null)
				this.small.push(data.prod_small_img2);
			if (Object.keys(data.prod_small_img3) != null)
				this.small.push(data.prod_small_img3);
			if (Object.keys(data.prod_small_img4) != null)
				this.small.push(data.prod_small_img4);
			// if (Object.keys(data.prod_small_img5) != null)
			// 	this.small.push(data.prod_small_img5);
			this.big = this.small[0];
		});
	},
};
