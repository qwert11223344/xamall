		...
		<div class="gray-box">
			...
			<div class="banner">
				...
				<div class="num">
					...
					<buy-num @editNum="editNum" :limit="Number(product.limitNum)" />
				</div>
				<div class="buy">
					<w-button
						text="加入购物车"
...
export default {
	...
	created() {
		...
		getDetail(this.productId).then((res) => {
			...
			if (data.prod_small_img1 != null) this.small.push(data.prod_small_img1);
			if (data.prod_small_img2 != null) this.small.push(data.prod_small_img2);
			if (data.prod_small_img3 != null) this.small.push(data.prod_small_img3);
			if (data.prod_small_img4 != null) this.small.push(data.prod_small_img4);
			if (data.prod_small_img5 != null) this.small.push(data.prod_small_img5);
			this.big = this.small[0];
		});
	},
};
