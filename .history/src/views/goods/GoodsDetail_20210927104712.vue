				...
				<div class="banner">
					...
					<div class="select-specification">
						...
						<div class="specification-count">
							<el-button plain>
								v-for="(item, index) in specification" :class="{ classStyle:
								product.count === 0 ? 'disabled-btn' : '', }"
								class="specification-item" @btnClick="specificationClick(index)"
								:class="{ active: specificationCurrent === index }" :key="index"
								:value="item" >
							</el-button>
						</div>
					</div>
