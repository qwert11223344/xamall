		...
		<div class="w store-content">
			<div class="gray-box">
				...
				<div class="banner">
					...
					<div class="num" v-if="product.count > 0">
				...
				<div class="cart" v-if="product.count > 0">
					<span>您已选择了</span>
...
export default {
	...
	methods: {
		colorClick(index) {
			...
			let a = this.product.allProds.filter((item) => {
				console.log(item.product_color === this.color[this.colorCurrent]);
				return (
					item.product_color === this.color[this.colorCurrent] &&
					item.product_capaity === this.specification[this.specificationCurrent]
				);
			});
			console.log(a);
			console.log(this.color[this.colorCurrent]);
			console.log(this.specification[this.specificationCurrent]);
		},
