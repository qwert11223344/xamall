...
import { getPublicKey, checkRegister, userRegister } from "api/user.js";
import { _setPublicKey, _encrypt } from "until/jsencrypt.js";
	...
	methods: {
		...
		_register() {
			userRegister({
				...
				userPwd: _encrypt(this.ruleForm.pass),
