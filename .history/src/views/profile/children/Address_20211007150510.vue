			...
			<template #content>
				<div class="md">
					...
					<div class="selectCity">
						<el-select
							v-model="msg.downtownArea"
							placeholder="请选择城市"
							@change="currentCity"
							style="width: 48%"
						>
							<el-option v-for="item in downtownArea" :value="item.name" />
						</el-select>
						<el-select
							v-model="msg.county"
							placeholder="请选择区县"
					...
					<div>
						<el-input v-model="msg.street" clearable placeholder="详细地址" />
					</div>
					<div>
	...
	methods: {
		...
		_addressAdd() {
			let params = {
				...
				downtownArea: this.msg.downtownArea,
