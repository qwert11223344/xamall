		...
		<w-shelf title="账户资料">
			<template #content>
				...
				<div class="avatar-box">
					...
					<el-button type="text" @click="_updateUserOne(0)">修改</el-button>
				</div>
				<div class="avatar-box">
					<div class="img-box">
						<i
				...
				<div class="avatar-box">
					...
					<el-button
						...
						@click="_updateUserOne(3)"
					></el-button>
				</div>

				<div class="update_info" v-if="showUpdateInfo">
					<w-shelf :title="title">
						<template #content>
							<div class="content">
								<el-form
								...
								>
									...
									<li>
										<el-button type="primary" plain :disabled="!checkForm"
											>提交</el-button
										>
										<el-button type="info" plain @click="showUpdateInfo = false"
											>返回</el-button
										>
									</li>
								</el-form>
...
import { checkRegister, updateUserOne } from "api/user.js";
