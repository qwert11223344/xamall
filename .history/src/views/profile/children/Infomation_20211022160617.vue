			...
			<div>
				<div :class="{ mask: loading }">
					<div class="avatar-box">
						...
						<el-button type="primary" @click="" round size="mini"
							>上传头像</el-button
						>
					</div>
					<div class="avatar-box">
				...
				<div class="upload_avatar">
					<w-shelf>
						<template #content>
							...
							<el-button type="info" plain @click="closeInfo">返回</el-button>
						</template>
					</w-shelf>
				</div>
...
export default {
	data() {
		...
		return {
			...
			titles: ["账户昵称", "手机验证", "修改密码", "绑定邮箱", "头像上传"],
			currentIndex: 0,
			dialogImageUrl: "", //上传头像
			dialogVisible: false,
			disabled: false,
