				...
				>
					<div v-for="(item, i) in orderList" :key="i">
						<div class="gray-sub-title cart-title">
							<div class="first">
								<div>
									<span class="date" v-text="item.created"></span>
									<span class="order-id">
										订单号：
										<a @click="orderDetail(item.order_num)">{{
											item.order_num
										}}</a>
									</span>
								</div>
							...
							<div class="last">
								...
								<span class="order-detail">
									<a @click="orderDetail(item.order_id)"
						...
						<div class="pr">
							<div class="cart" v-for="(good, j) in item.prod_list" :key="j">
								<div class="cart-l" :class="{ bt: j > 0 }">
									<div class="car-l-l">
										<div class="img-box">
											<a @click="goodsDetails(good.prod_id)"
										...
										<div class="ellipsis">
											<a
												style="color: #626262"
												@click="goodsDetails(good.prod_id)"
												>{{ good.prod_title }}</a
											>
										</div>
									</div>
							...
							<div class="prod-operation pa" style="right: 0; top: 0">
								...
								<div v-if="item.state === 0" class="status">
									<el-button
										@click="orderPayment(item._id)"
										type="primary"
										plain
										round
										size="mini"
...
import moduleName from "until/utils.js";
