									...
									<div class="cart-top-items">
										<div class="cart-items clearfix">
											...
											<div class="items-choose">
												<el-checkbox v-model="checkList[i]"></el-checkbox>
											</div>
											<!--图片-->
							...
							<div class="cart-bar-operation">
								<div>
									<div class="choose-all">
										<el-checkbox v-model="checkAll" @click="_checkAll"
											>全选</el-checkbox
										>
									</div>
...
import { getCartList } from "api/user.js";
		...
		_getCartList() {
			getCartList({
				...
				if (res.success === true) {
					...
					this.checkList = new Array(this.cartList.length).fill(false);
				}
			});
		},
		//全选
