										...
										<div class="cart-items clearfix">
											...
											<div>
												...
												<buy-num
													...
													"
													@editNum="_updateProdNum(arguments, item.prod_count)"
												>
												</buy-num>
												<!--价格-->
...
import { getCartList, increaseProdNum, reduceProdNum } from "api/user.js";
...
export default {
	...
	methods: {
		...
		// 修改购物车数量
		_updateProdNum(arg, num) {
			let opera = arg[0].opera;
			if (opera === "up") {
			}
