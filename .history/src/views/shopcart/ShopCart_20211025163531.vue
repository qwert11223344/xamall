	...
	<div class="shopping-cart">
		...
		<div class="store-content page-cart">
			<div class="gray-box">
						...
						<div class="fix-bottom-inner">
							<div class="cart-bar-operation">
								<div>
									...
									<div class="delete-choose-goods" @click="_delCartMore">
										删除选中的商品
									</div>
								</div>
							</div>
							<div class="shipping">
								...
								<el-button type="primary" round plain @click="toBuy">{{
									checkoutNow
								}}</el-button>
							</div>
						</div>
				...
				<div v-else style="padding: 80px 50px">
					<el-empty description="您的购物车空空如也~"></el-empty>
					<router-link to="/goods">
						<el-button type="primary" round plain style="margin: 10px 520px"
							>去选购</el-button
						></router-link
					>
				</div>
...
export default {
	...
	computed: {
		...
		// 选中的总价格
		checkPrice() {
			return this.checkList.reduce((oldValue, cur) => {
