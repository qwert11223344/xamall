			...
			<div>
				<div :class="{ mask: loading }">
					...
					<div class="avatar-box">
						<div class="img-box">
							<i
								...
								:class="userInfo.username ? 'success' : 'warn'"
							></i>
						</div>
						<div class="r-box">
							<h3>账户昵称</h3>
					...
					<div class="avatar-box">
						<div class="img-box">
							<i
								...
								:class="userInfo.phone ? 'success' : 'warn'"
							></i>
						</div>
						<div class="r-box">
							<h3>手机验证</h3>
					...
					<div class="avatar-box">
						<div class="img-box">
							<i
								class="iconfont"
								v-html="userInfo ? icon.success : icon.warn"
								:class="userInfo ? 'success' : 'warn'"
								>&#xe607;</i
							>
						</div>
						<div class="r-box">
					...
					<div class="avatar-box">
						<div class="img-box">
							<i
								...
								:class="userInfo.email ? 'success' : 'warn'"
								>&#xe607;</i
							>
						</div>
						<div class="r-box">
				...
				<div class="upload_avatar update_info" v-show="showUploadAvatar">
					<w-shelf title="上传头像">
						<template #content>
							<el-upload
								action="http://localhost:3333/user/uploadAvatar"
								ref="upload"
							...
							<div class="btn">
								<el-button type="primary" @click="uploadAvatar" plain
									>上传</el-button
								>
								<el-button type="info" plain @click="closeUpload"
									>返回</el-button
								>
							</div>
						</template>
...
export default {
	...
	methods: {
		...
		//上传头像超出限额
		handleExceed() {
			this.message("当前限制选择 1张图片!", "warning");
		},
		// 预览头像
		...
		beforeAvatarUpload(file) {
			...
			if (file.type != "image/jpeg" && file.type != "image/png") {
				this.message("图片类型仅支持jpeg,jpg,png", "error");
				return false;
			}
			return true;
		},
